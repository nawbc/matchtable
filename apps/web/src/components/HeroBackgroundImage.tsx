...
/**
 * Radix website BackgroundImage (page.client.tsx) — paths, gradients, and layout unchanged.
 * Color tokens are set via `style` (tealBackgroundImageStyle) on this SVG.
 */
    ...
    >
      <g>
        <path
          ...
          fill={`url(#paint0_radial_37_453-${gradientId})`}
        />
        <path
          ...
          fill={`url(#paint1_radial_37_453-${gradientId})`}
        />
        <path
        ...
        <path
          ...
          fill={`url(#paint4_radial_37_453-${gradientId})`}
        />
      </g>
      <defs>
        <radialGradient
          id={`paint3_radial_114_43-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
        ...
        <radialGradient
          id={`paint4_radial_114_43-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint5_radial_114_43-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint6_radial_114_43-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint0_radial_37_453-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint1_radial_37_453-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint2_radial_37_453-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint3_radial_37_453-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
        ...
        <radialGradient
          id={`paint4_radial_37_453-${gradientId}`}
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
